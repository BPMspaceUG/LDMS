...
if (!window.objPHPDate)
{
	window.objPHPDate =
	{
		...
		aMonth: ['Januar', 'Februar', 'März', 'April', 'Ma', 'Juni', 'Juli', 'August', 'September', 'Oktober', 'November', 'Dezember'],
...
if (!window.DateChooser)
{
	window.DateChooser = function()
	{
		...
		var RefreshDisplay = function()
		{
			...
			ndA.setAttribute('title', 'Letztes Jahr');
			...
			ndA.setAttribute('href', '#');
			ndA.setAttribute('title', 'Letzter Monat');
			ndTH.appendChild(ndA);
			...
			ndA.setAttribute('href', '#');
			ndA.setAttribute('title', 'Aktuelles Datum');
			ndTH.appendChild(ndA);
			...
			ndA.setAttribute('href', '#');
			ndA.setAttribute('title', 'Nächster Monat');
			ndTH.appendChild(ndA);
			...
			ndA.setAttribute('href', '#');
			ndA.setAttribute('title', 'Nächstes Jahr');
			ndTH.appendChild(ndA);
		...
		{
			var sLinkText = ((arguments.length > 0) && (typeof(arguments[0]) == 'string')) ? arguments[0] : 'Datum auswählen';
			...
			var sTitleText = ((arguments.length > 3) && (typeof(arguments[3]) == 'string')) ? arguments[3] : 'Klicken um Datum auszuwählen';
